...
import { authenticate, requireClientRole } from '../middleware/authMiddleware.js';

export const setupLocationRoutes = (router, options = {}) => {
  const sequelize = options.sequelize || options.sequelizeInstance;
...
export default setupLocationRoutes;
